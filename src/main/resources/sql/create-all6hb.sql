...
create table leagues_teams(
  league_id bigint NOT NULL,
  team_id bigint NOT NULL,
  CONSTRAINT leaguesteams_leagueid_fkey FOREIGN KEY (league_id) REFERENCES league(league_id),
  CONSTRAINT leaguesteams_teamid_fkey FOREIGN KEY (team_id) REFERENCES team(team_id)
)
